...
## 3.1 赋值和局部状态
### 3.1.1 局部状态变量
### [练习3.1](chapter2/2.2.ipynb/#31)
### [练习3.2](chapter2/2.2.ipynb/#32)
### [练习3.3](chapter2/2.2.ipynb/#33)
### [练习3.4](chapter2/2.2.ipynb/#34)
### 3.1.2 引进赋值带来的利益
### [练习3.5](chapter2/2.2.ipynb/#35)
### [练习3.6](chapter2/2.2.ipynb/#36)
### 3.1.3 引进赋值带来的代价
## 3.2 求值的环境模型
### 3.2.1 求值规则
### 3.2.2 简单过程的应用
